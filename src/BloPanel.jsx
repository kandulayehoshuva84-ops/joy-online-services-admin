...
const EMPTY_VOTER = {
  ...
  part_name_local:'', language:'Telugu', address:'', address_local:'', request_type:'New Registration', status:'Pending'
};
...
export default function BloPanel({ user, onBack }) {
  ...
  function newApplication(type) {
    setEditingId(null);
    setVoter({ ...EMPTY_VOTER, request_type:type });
    setSection('original');
  }
